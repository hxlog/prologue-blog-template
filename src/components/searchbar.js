  ...
  return (
    <div className="max-w-2xl mx-auto relative">
      <input
        ...
        className="block w-full rounded-md border border-zinc-300 bg-white px-4 py-2 text-zinc-900 focus:border-zinc-500 focus:ring-zinc-500  drop-shadow-xs focus:drop-shadow-sm dark:border-zinc-900 dark:bg-zinc-800 dark:text-zinc-100"
      />
      <svg
